...
Since we aren't doing world creation, and thus Facts, you can skip all the stuff about [Demiurges](../introduction.md#demiurge) and [](../world_creation/facts.md).
...
```{image} /_static/heroes_emerge.jpg
:width: 33%
:align: right
```

Replace [Trouble](../hero_creation/character_creation.md#trouble) with Drawback.
...
* Many of the usual Drawbacks that are more roleplaying related are captured by [](../hero_creation/paths.md) and so should be acquired that way.  
...
* Consider which [](../hero_creation/boons/boons.md) will survive the apocalypse.
  
#### Locations

The Tier 1 [](../hero_creation/boons/location.md) are:
...
Cost: XP cost for [](../hero_creation/edges.md) is reduced to 15xp.
...
* Gain one [](../tools/currency.md#favor) at the beginning of each scene up to a maximum of 3.
...
If two Heroes wish to [work together](../tools/modifiers.md#working-together), under base rules one hero can lend a boon and it would replace whatever the other Hero could use for that pool in their strategy (if it makes sense). 
