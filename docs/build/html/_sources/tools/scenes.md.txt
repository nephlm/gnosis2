...
[Framing](#framing), 
[narration](#narration) and 
[recovery](#recovery).

```{admonition} Scenes as Time

Many things are measured in scenes as if it were a measure of time.  Some 
[Edges](../hero_creation/edges.md), [Modifiers](modifiers.md) or 
...
get the most out of it.  Heroes have 
[Quests](../hero_creation/quests.md), 
[Paths](../hero_creation/paths.md), 
[Kith](../hero_creation/boons/kith.md), 
[Locations](../hero_creation/boons/location.md) 
and even some 
[Gear](../hero_creation/boons/gear.md) and 
[Talents](../hero_creation/boons/talents.md) that 
...
Narration is the meat of the scene. 
...
That's when the challenge and [resolution](../play/challenge.md) mechanics
come into the play and players end up rolling dice. 

Most of the bits around that mechanical resolution
are someone [narrating](../play/play.md#exploration--action). 
Maybe players narrating what 
...
recovery.  If 
[Wounds or Trauma](../play/consequences.md#wounds-and-trauma) 
was taken there is a 
chance to recover from that, and take care of any 
other post-scene issues.  Heroes may also gain a [Favor](currency.md#favor)
if they used all their Favor or if they took Wound or Trauma.
